...
namespace lingyiLib\MiddleSdk\Kernel\Log;
...
class LogManager implements LoggerInterface
{
    ...
    {
        return new Monolog('lingyilib', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir().'/lingyilib/middle-php-sdk.log',
